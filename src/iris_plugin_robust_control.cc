...
*/
   ...
   // std::cout << this->iris_state_vel[3] <<" "<< this->iris_state_vel[4] << "\n";
	...
	public: void control_state_feedback(){
		...
		//Update Control
		this->calculate_control_feedback(K_lqr);
	...
	public: void state_array_update(){
		...
		//Error output
		this->control_state_array[8] = this->iris_state_ref[2] - this->iris_state[2];
		this->control_state_array[9] = this->iris_state_ref[3] - this->iris_state[3];
		this->control_state_array[10] = this->iris_state_ref[4] - this->iris_state[4];
		this->control_state_array[11] = this->iris_state_ref[5] - this->iris_state[5];
	}
	...
	private: double control_state_array[12];
